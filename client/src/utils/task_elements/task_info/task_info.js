...
export default function TaskInfo(props) {
  ...
  const infoStyle = () => {
    ...
    if (props.isActive) {
      return { ...defaultStyle, height: heightInfo };
    } else {
      return { ...defaultStyle, height: 0 };
    }
  };
  ...
  return (
    <div className="task-info-wrap" style={infoStyle()}>
      <div className="task-info-main" ref={infoRef}>
        {props.isTask && (
          <div>
            {props.description.length === 0 && props.additions.length === 0 ? (
        ...
        {props.isWork && (
          <div>
            ...
            <div className="work-btns-wrap">
              <AddFileBtn id={props.id} workInfo={props.grade} />
              <SubmitWorkBtn
                id={props.id}
